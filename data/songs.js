...
අතරේ අහනවා බලනවා මේ අපි කවුරුද..`
  ...
  {
    id: 2,
    titleRoman: 'Sanasennam Ma',
    titleSi:    'සැනසෙන්නම් මා',
    artist:     'Senaka Batagoda',
    key:        'G',
    beat:       '4/4',
    capo:       0,
    tags:       ['top100'],
    description: 'Sanasennam Ma (සැනසෙන්නම් මා) by Senaka Batagoda is a beautiful Sinhala love song. Guitar chords in G — uses G, C, D, D7, Bm, Am. One of the most searched Sinhala chord sheets online.',
    content:
`[Intro]
|G |C |G |C |
|D |D7 |Bm |D |
...
සෙනෙහස විඳ පිපිරෙයි සිත`
...

  {
    ...
    capo:       0,
    tags:       ['top100'],
    description: 'Eda Rea (එදා රෑ) by Milton Mallawarachchi is a timeless Sinhala classic. Guitar chords in Am — uses Am, G, Dm, C, E, A, D. A favourite for guitarists of all levels.',
    content:
`[Intro]
|Am |- |- |- |
|G |- |- |- |
...
එය කීමටයි ලතැවුණේ`
  ...
  {
    id: 4,
    titleRoman: 'Niyare Piyanegala',
    titleSi:    'නියරේ පිය නඟලා',
    artist:     'Saman De Silva',
    key:        'Em',
    beat:       '4/4',
    capo:       0,
    tags:       ['top100'],
    description: 'Niyare Piyanegala (නියරේ පිය නඟලා) by Saman De Silva is a beautiful folk-influenced Sinhala song. Guitar chords in Em — uses Em, D, C, G, Am, Bm. Perfect for beginner and intermediate Sinhala guitar players.',
    content:
`[Intro]
|Em |- |C |- |
|D |- |G |- |
...
වාසනාව පාවෙලා ගියා`
  ...
  {
    id: 5,
    titleRoman: 'Labendiye',
    titleSi:    'ළබැඳියේ',
    artist:     'Lahiru Perera',
    key:        'A',
    beat:       '4/4',
    capo:       0,
    tags:       ['top100'],
    description: 'Labendiye (ළබැඳියේ) by Lahiru Perera is one of the most popular contemporary Sinhala love songs. Guitar chords in A — uses A, F#m, D, E, Bm. A must-learn for Sinhala guitar players.',
    content:
`[Intro]
|A |- |F#m |- |D |- |E |- |
...
ඔබ යන්න සුළඟේ අප තමා...`
...

  {
    ...
    capo:       0,
    tags:       ['top100'],
    description: 'Sheela (ෂීලා) by JayaSri is one of the most iconic Sinhala songs ever written. Guitar chords in Am — uses Am, Em, G, E, C, F, Dm. A classic that every Sinhala guitarist should know.',
    content:
`Am              Em
...
එයිදෝ මගේ කුමාරී...`
...

  {
    ...
    capo:       0,
    tags:       ['top100'],
    description: 'Ratakin Eha (රටකින් එහා) by Priya Sooriyasena is a popular Sinhala love song. Guitar chords in A — uses A, E, F#m, C#m, D, Bm. Great for intermediate Sinhala guitar players.',
    content:
`[Intro]
|A |F#m |Bm |- |
|Bm |D |E |A |
...
කිසිදා බිඳෙන්නෑ සැකයක් නැතේ...`
  ...
  {
    id: 8,
    titleRoman: 'Awata Nokiyama Jeewithen',
    titleSi:    'ආවාට නොකියාම ජීවිතෙන්',
    artist:     'Athma Liyanage',
    key:        'Dm',
    beat:       '4/4',
    capo:       0,
    tags:       ['top100'],
    description: 'Awata Nokiyama Jeewithen (ආවාට නොකියාම ජීවිතෙන්) by Athma Liyanage is a deeply emotional Sinhala song. Guitar chords in Dm — uses Dm, C, Bb, F, Am. One of the most played Sinhala songs on guitar.',
    content:
`[Intro]
|Dm |- |Bb |- |
|F |- |C |- |
...
|C |Am |Dm |`
  ...
  {
    id: 9,
    titleRoman: 'ThaniWennata Mage Lowe',
    titleSi:    'තනිවෙන්නට මගේ ලොවේ',
    artist:     'Victor Rathnayake',
    key:        'Gm',
    beat:       '4/4',
    capo:       0,
    tags:       ['top100'],
    description: 'ThaniWennata Mage Lowe (තනිවෙන්නට මගේ ලොවේ) by Victor Rathnayake is a classic Sinhala song. Guitar chords in Gm — uses Gm, Eb, Bb, Cm, F, D. One of the most iconic songs by the legendary Sri Lankan vocalist.',
    content:
`[Intro]
|Gm |Eb |Bb |- |
|Gm |Eb |Cm |Cm |
...
ශෝ ගීයකී දුක්බර වූ සැනසුම කොහි වේදෝ`
  ...
  {
    id: 10,
    titleRoman: 'Kaulu Piyanpath',
    titleSi:    'කවුළු පියන්පත්',
    artist:     'Kasun Kalhara',
    key:        'G',
    beat:       '4/4',
    capo:       0,
    tags:       ['top100'],
    description: 'Kaulu Piyanpath (කවුළු පියන්පත්) by Kasun Kalhara is a poetic Sinhala ballad. Guitar chords in G — uses G, D, C, Bm, Em, Am, D7. A beautiful song for guitarists at all levels.',
    content:
`[Intro]
|G |- |D |- |
|C |- |D |- |
